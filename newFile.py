...
# --> This is 20b01a0593 from SVECW
wordList = [
    "tiger", "umbrella", "window", "computer", "glass", "juice", "chair", "desktop",
    "laptop", "dog", "cat", "lemon", "cable", "mirror", "hat", "bat", "table",
    "book", "phone", "pen", "keyboard", "light", "flower", "paper", "candle",
    "guitar", "shoes", "keyboard", "bag", "coffee", "sunset", "beach", "mountain",
    "camera", "clock", "globe", "piano", "door", "tree", "socks", "scarf",
    "cloud", "moon", "star", "cake", "cookie", "icecream", "car", "bike",
    "train", "plane", "ship", "wallet", "key", "map", "glasses", "hat",
    "guitar", "ball", "garden", "painting", "brush", "music", "pillow", "lamp",
    "fish", "shark", "octopus", "elephant", "lion", "bear", "snake", "rabbit",
    "turtle", "parrot", "apple", "banana", "orange", "strawberry", "watermelon", "pineapple"
]
